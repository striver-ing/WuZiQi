...
void BleManager::addReceiveMessageCallBack(ReceiveMessageCallback receiveMessageCallback) {
    [[BlueToothController getInstance] addReceiveMessageCallBack:receiveMessageCallback];
}